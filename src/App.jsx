...
//     const { fullName, country, city, street, latitude, longitude } = locationData;

//     if (!fullName || !country || !city || !street || !latitude || !longitude) {
...
//         <MapContainer
//           center={[-6.8, 39.2]} // Default: Dar es Salaam
//           zoom={6}
